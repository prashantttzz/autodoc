...
export type testOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name", ExtArgs["result"]["test"]>
...
export interface testDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const testWithNameOnly = await prisma.test.findMany({ select: { name: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Tests and only return the `name`
   * const testWithNameOnly = await prisma.test.createManyAndReturn({
   *   select: { name: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Tests and only return the `name`
   * const testWithNameOnly = await prisma.test.updateManyAndReturn({
   *   select: { name: true },
   *   where: {
   *     // ... provide filter here
   *   },
